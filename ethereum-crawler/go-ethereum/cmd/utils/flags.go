...
import (
	...
	"github.com/pnomarev/go-ethereum/eth"
	...
	"github.com/pnomarev/go-ethereum/metrics"
	"github.com/pnomarev/go-ethereum/p2p/nat"
	"github.com/pnomarev/go-ethereum/params"
	"github.com/pnomarev/go-ethereum/rpc/api"
	"github.com/pnomarev/go-ethereum/rpc/codec"
	"github.com/pnomarev/go-ethereum/rpc/comms"
	"github.com/pnomarev/go-ethereum/rpc/shared"
	"github.com/pnomarev/go-ethereum/rpc/useragent"
	"github.com/pnomarev/go-ethereum/xeth"
)
...
var (
	ListenOnlyFlag = cli.BoolFlag{
		Name:  "listenonly",
		Usage: "Only listens to broadcastings",
	}
...
func MakeEthConfig(clientID, version string, ctx *cli.Context) *eth.Config {
	...
	fmt.Println(ctx.GlobalBool(ListenOnlyFlag.Name))
	
	// Assemble the entire eth configuration and return
	cfg := &eth.Config{
		ListenOnlyMode:          ctx.GlobalBool(ListenOnlyFlag.Name),
