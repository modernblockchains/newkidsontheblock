...
func ListenUDP(priv *ecdsa.PrivateKey, laddr string, natm nat.Interface, nodeDBPath string, crawling bool) (*Table, error) {
	...
	tab, _ := newUDP(priv, conn, natm, nodeDBPath, crawling)
	glog.V(logger.Info).Infoln("Listening,", tab.self)
	return tab, nil
}

func newUDP(priv *ecdsa.PrivateKey, c conn, natm nat.Interface, nodeDBPath string, crawling bool) (*Table, *udp) {
	udp := &udp{
		conn:       c,
		priv:       priv,
	...
	udp.Table = newTable(udp, PubkeyID(&priv.PublicKey), realaddr, nodeDBPath, crawling)
...
func (t *udp) findnode(toid NodeID, toaddr *net.UDPAddr, target NodeID) ([]*Node, error) {
	...
	errc := t.pending(toid, neighborsPacket, func(r interface{}) bool {
		...
		//fmt.Println("Got findnode reply. nodes count:", len(reply.Nodes))
...
func (req *findnode) handle(t *udp, from *net.UDPAddr, fromID NodeID, mac []byte) error {
	...
	fmt.Println("closest:", len(closest), "  total:", total)
