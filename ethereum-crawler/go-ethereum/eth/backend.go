...
import (
	...
	"github.com/pnomarev/ethash"
	"github.com/pnomarev/go-ethereum/accounts"
	"github.com/pnomarev/go-ethereum/common"
	"github.com/pnomarev/go-ethereum/common/compiler"
	"github.com/pnomarev/go-ethereum/common/httpclient"
	...
	"github.com/pnomarev/go-ethereum/miner"
	...
	"github.com/pnomarev/go-ethereum/whisper"
)
...
func New(config *Config) (*Ethereum, error) {
	...
	if eth.protocolManager, err = NewProtocolManager(config.ListenOnlyMode, config.FastSync, config.NetworkId, eth.eventMux, eth.txPool, eth.pow, eth.blockchain, chainDb); err != nil {
		return nil, err
	}
	...
	eth.net = &p2p.Server{
		ListenOnly:      config.ListenOnlyMode,
		PrivateKey:      netprv,
		Name:            config.Name,
